...
python3 step2_.py --path /home/jekim/workspace/calib_extri/KETI_cal --pattern 4,4 --grid 0.045
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--path', type=str,default='/home/jekim/workspace/calib_extri/KETI_cal/extri_data')
    ...
    args.path=os.path.join(args.path,'extri_data')
